...
La génération CI utilise Flutter 3.44.4 sur Ubuntu afin de conserver un rendu reproductible. Elle vérifie les goldens, la matrice, l’accessibilité puis l’analyse Flutter avant de publier les images.
