...
class HomeMapPageV3 extends StatefulWidget {
  const HomeMapPageV3({super.key});

  @override
  State<HomeMapPageV3> createState() => _HomeMapPageV3State();
}

class _HomeMapPageV3State extends State<HomeMapPageV3>
  ...
  void initState() {
    ...
    debugPrint('🗺️ HomeMapPageV3: initState called');
  ...
  void didChangeAppLifecycleState(AppLifecycleState state) {
    ...
    switch (state) {
      case AppLifecycleState.resumed:
        debugPrint('🗺️ HomeMapPageV3: App resumed, relancer GPS');
        _bootstrapLocation();
        break;
      case AppLifecycleState.paused:
        debugPrint('🗺️ HomeMapPageV3: App paused');
        break;
      case AppLifecycleState.detached:
        debugPrint('🗺️ HomeMapPageV3: App detached');
        break;
      case AppLifecycleState.inactive:
        debugPrint('🗺️ HomeMapPageV3: App inactive');
        break;
      case AppLifecycleState.hidden:
        debugPrint('🗺️ HomeMapPageV3: App hidden');
        break;
    }
  }
            ...
            Positioned.fill(
              child: FlutterMap(
                ...
                options: MapOptions(
                  ...
                  onMapReady: () {
                    debugPrint('🗺️ HomeMapPageV3: Carte FlutterMap prête');
                    setState(() {
                      _isMapReady = true;
                      _checkIfReady();
                    });
