...
import 'features/commerce/data/storage_repository.dart';
...
class ProductController extends ChangeNotifier {
  ...
  Stream<List<commerce_models.Category>> streamCategories() =>
      commerceRepo.streamCategories(shopId);
...
class _BoutiquePageState extends State<BoutiquePage> {
  ...
  double get total =>
      cart.values.fold<double>(0, (s, i) => s + (i.product.price * i.qty));
                ...
                children: [
                  ...
                  FilledButton(
                    onPressed: items.isEmpty
                        ...
                        : () async {
                            try {
                              final orderId = await c.commerceRepo
                                  .checkoutCreateOrder(
                                    shopId: widget.shopId,
                              ...
                              TopSnackBar.show(
                                context,
                                SnackBar(
                                  content: Text('Checkout impossible: $e'),
                                ),
                              );
                            }
                          },
