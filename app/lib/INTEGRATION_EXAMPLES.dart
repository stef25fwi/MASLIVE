...
/// Ce fichier contient des exemples d'intégration pour des classes
/// qui n'existent plus (MediaShopWrapper, GalleryCartProvider, etc.).
///
/// Voir la documentation Commerce pour les patterns d'intégration actuels.
